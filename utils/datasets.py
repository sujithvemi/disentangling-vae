...
class NewDSprites(DisentangledDataset):
    """NewDSprites Dataset from [2].

    Enhanced disentanglement test dSprites dataset with higher resolutions and different shapes defined in configurations. 
    Procedurally generated 2D shapes, from 6 disentangled latent factors. 
    This dataset uses 6 latents, controlling the color, shape, scale, rotation and position of a sprite. 
    All possible variations of the latents are present.
    Ordering along dimension 1 is fixed and can be mapped back to the exact latent values that generated that image. 
    We made sure that the pixel outputs are different. No noise added.

    Notes
    -----
    - Link : https://github.com/sujithvemi/new-dsprites-higher-res [2]
    - hard coded metadata because issue with python 3 loading of python 2
    ...
    """
    files = {"train": "new_dSprites_256x256.npz"}
    lat_names = ('shape', 'scale', 'posX', 'posY')
    lat_sizes = np.array([3, 11, 206, 206])
    img_size = (1, 256, 256)
    background_color = COLOUR_BLACK
    lat_values = {
        'posX':
        np.array([0., 0.00487805, 0.0097561, 0.01463415, 0.0195122,
       0.02439024, 0.02926829, 0.03414634, 0.03902439, 0.04390244,
       0.04878049, 0.05365854, 0.05853659, 0.06341463, 0.06829268,
       0.07317073, 0.07804878, 0.08292683, 0.08780488, 0.09268293,
       0.09756098, 0.10243902, 0.10731707, 0.11219512, 0.11707317,
       0.12195122, 0.12682927, 0.13170732, 0.13658537, 0.14146341,
       0.14634146, 0.15121951, 0.15609756, 0.16097561, 0.16585366,
       0.17073171, 0.17560976, 0.1804878, 0.18536585, 0.1902439,
       0.19512195, 0.2, 0.20487805, 0.2097561, 0.21463415,
       0.2195122, 0.22439024, 0.22926829, 0.23414634, 0.23902439,
       0.24390244, 0.24878049, 0.25365854, 0.25853659, 0.26341463,
       0.26829268, 0.27317073, 0.27804878, 0.28292683, 0.28780488,
       0.29268293, 0.29756098, 0.30243902, 0.30731707, 0.31219512,
       0.31707317, 0.32195122, 0.32682927, 0.33170732, 0.33658537,
       0.34146341, 0.34634146, 0.35121951, 0.35609756, 0.36097561,
       0.36585366, 0.37073171, 0.37560976, 0.3804878, 0.38536585,
       0.3902439, 0.39512195, 0.4, 0.40487805, 0.4097561,
       0.41463415, 0.4195122, 0.42439024, 0.42926829, 0.43414634,
       0.43902439, 0.44390244, 0.44878049, 0.45365854, 0.45853659,
       0.46341463, 0.46829268, 0.47317073, 0.47804878, 0.48292683,
       0.48780488, 0.49268293, 0.49756098, 0.50243902, 0.50731707,
       0.51219512, 0.51707317, 0.52195122, 0.52682927, 0.53170732,
       0.53658537, 0.54146341, 0.54634146, 0.55121951, 0.55609756,
       0.56097561, 0.56585366, 0.57073171, 0.57560976, 0.5804878,
       0.58536585, 0.5902439, 0.59512195, 0.6, 0.60487805,
       0.6097561, 0.61463415, 0.6195122, 0.62439024, 0.62926829,
       0.63414634, 0.63902439, 0.64390244, 0.64878049, 0.65365854,
       0.65853659, 0.66341463, 0.66829268, 0.67317073, 0.67804878,
       0.68292683, 0.68780488, 0.69268293, 0.69756098, 0.70243902,
       0.70731707, 0.71219512, 0.71707317, 0.72195122, 0.72682927,
       0.73170732, 0.73658537, 0.74146341, 0.74634146, 0.75121951,
       0.75609756, 0.76097561, 0.76585366, 0.77073171, 0.77560976,
       0.7804878, 0.78536585, 0.7902439, 0.79512195, 0.8,
       0.80487805, 0.8097561, 0.81463415, 0.8195122, 0.82439024,
       0.82926829, 0.83414634, 0.83902439, 0.84390244, 0.84878049,
       0.85365854, 0.85853659, 0.86341463, 0.86829268, 0.87317073,
       0.87804878, 0.88292683, 0.88780488, 0.89268293, 0.89756098,
       0.90243902, 0.90731707, 0.91219512, 0.91707317, 0.92195122,
       0.92682927, 0.93170732, 0.93658537, 0.94146341, 0.94634146,
       0.95121951, 0.95609756, 0.96097561, 0.96585366, 0.97073171,
       0.97560976, 0.9804878 , 0.98536585, 0.9902439, 0.99512195,
       1.]),
        'posY':
        np.array([0., 0.00487805, 0.0097561, 0.01463415, 0.0195122,
       0.02439024, 0.02926829, 0.03414634, 0.03902439, 0.04390244,
       ...
       1.]),
        'scale':
        np.array([0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1.]),
        'orientation':
        np.array([0.]),
        'shape':
        np.array([1., 2., 3.]),
